  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Add New Education</h4>
        </div>
          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/education/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">Education Name</label>
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add education" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
