   ...
   <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-list"></i> &nbsp; Applicant Listing</h4>
        </div>
        <div class="col-md-6">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a title="Shortlist" class="btn btn-xs btn-success pull-right" href="<?= base_url('admin/applicants/make_shortlist/'.$applicant['id'].'/'.$applicant['job_id']); ?>">Shortlist Candidate</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
